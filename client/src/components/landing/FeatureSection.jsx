  ...
  return (
    <section className='bg-white dark:bg-gray-900'>
      <div className='py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6'>
        ...
        <div className='space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0 dark:text-white'>
          <div>
            ...
            <p className='text-gray-500 dark:text-gray-400'>
              Soal pilihan yang diantaranya diambil dari soal tes CPNS tahun
              sebelumnya dan merupakan soal terbaik CPNS Indonesia dan Dirancang
              Oleh Tim JagoCpns.id
            </p>
          </div>
          <div>
            <div className='flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900'>
            ...
            <p className='text-gray-500 dark:text-gray-400'>
              ...
              untuk merasakan sensasi soal-soal Try Out CPNS Indonesia.
            </p>
          </div>
          <div>
            <div className='flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900'>
            ...
            <p className='text-gray-500 dark:text-gray-400'>
              Sistem Try out untuk evaluasi kemampuan hasil belajar.
            </p>
          </div>
          <div>
            <div className='flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900'>
            ...
            <p className='text-gray-500 dark:text-gray-400'>
              Bandingkan hasilmu dengan para pesaing lainnya di Ranking
              Nasional! Tingkatkan terus kesiapanmu menuju CPNS 2024.
            </p>
          </div>
          <div>
            <div className='flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900'>
