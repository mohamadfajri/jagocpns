...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        id='default-sidebar'
        className='fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 border-r border-gray-300 dark:border-gray-700 dark:bg-black'
        aria-label='Sidebar'
      >
