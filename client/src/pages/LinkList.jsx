        ...
        <div className="flex flex-col gap-5">
          <a href="https://jagocpns.id/">
            <div className="border w-full flex items-center p-5 gap-3 rounded-xl hover:border-[#FFCB01] hover:shadow-xl transition-shadow">
              ...
              <div>
                <p className="font-bold text-xl">Website Jagospncs.id</p>
            ...
            <div className="border w-full flex items-center p-5 gap-3 rounded-xl hover:border-[#FFCB01] hover:shadow-xl transition-shadow">
              ...
              <div>
                <p className="font-bold text-xl">
                  Daftar TryOut SKB (ALL Formasi)
                </p>
                <p className="text-gray-400">Kunjungi Website Resmi Kami</p>
              </div>
            </div>
          </a>
          <a href="https://api.whatsapp.com/send/?phone=+62895624999799&text=Isi%20Request%20Bimbel%20Formasi%20Kamu%2BInstansi%20apa">
            <div className="border w-full flex items-center p-5 gap-3 rounded-xl hover:border-[#FFCB01] hover:shadow-xl transition-shadow">
              <div>
                <svg
              ...
              <div>
                <p className="font-bold text-xl">
                  {`Bimbel SKB Coming Soon (Request Admin)`}
                </p>
                <p className="text-gray-400">Click for more iformations</p>
              </div>
            </div>
          </a>
          ...
          <a href="https://www.instagram.com/jagocpns.id/">
            <div className="border w-full flex items-center p-5 gap-3 rounded-xl hover:border-[#FFCB01] hover:shadow-xl transition-shadow">
              ...
              <div>
                ...
                <p className="text-gray-400">Instagram Jagocpns.id</p>
              </div>
            </div>
          </a>
        </div>
